...
function MainApp() {
  ...
  return <div className="flex flex-col h-screen bg-surface-base overflow-hidden text-ink-primary pb-safe"><header className="w-full z-20 pt-safe-top"><div className="px-4 py-4 flex items-center justify-between"><div className="flex items-center gap-4"><MatrixLogo activeTab={activeTab} /><div className="flex flex-col justify-center"><span className="text-[13px] font-normal text-[#8E929B] leading-none mb-1.5">{greeting}, User 👋🏽</span><span className="text-[20px] font-bold text-white leading-none">{contextStatus}</span></div></div><div className="w-2 h-2 rounded-full bg-accent shrink-0" aria-hidden="true" /></div></header>
